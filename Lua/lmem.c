...
#define blocksize(b)	((unsigned *)((char *)(b) - HEADER))

unsigned memdebug_numblocks = 0;
unsigned memdebug_total = 0;
unsigned memdebug_maxmem = 0;
unsigned memdebug_memlimit = LONG_MAX;


static void *checkblock (void *block) {
  unsigned *b = blocksize(block);
  unsigned size = *b;
  int i;
